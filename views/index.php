        ...
        <form class="col-lg-8 border bg-light p-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="number" step="0.01" min="0" name="cli_nit" id="cli_nit" class="form-control" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="cli_telefono">Telefono del Cliente</label>
                    <input type="tel" step="0.01" min="0" name="cli_telefono" id="cli_telefono" class="form-control" required>
                </div>
            </div>
            <div class="row justify-content-center mb-3">
                <div class="col">
